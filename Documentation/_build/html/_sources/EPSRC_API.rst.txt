...
.. autoclass:: EPSRC_API_access.EPSRC_API
	:members:

Stand-Alone Functions
----------------------------

.. autofunction:: EPSRC_API_access.getInput

.. autofunction:: EPSRC_API_access.explicitPostRequest
...
.. code-block:: python
	...
	EPSRC_API.headerJSON = {'accept': 'application/vnd.rcuk.gtr.json-v6'}

and

.. code-block:: python

	EPSRC_API.headerXML = {'accept': 'application/vnd.rcuk.gtr.xml-v6'}
...
GTR's documentation is a bit threadbare (so far as I could find). The above was deduced from the `GTR technical summary <http://gtr.rcuk.ac.uk/resources/GtR-2-API-v1.7.pdf>`_.
